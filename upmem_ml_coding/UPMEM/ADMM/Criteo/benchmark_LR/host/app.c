                    ...
                    for (uint32_t se = 0; se < array_reg_term_alpha_length; ++se) { 
                        ...
                        for (uint32_t le = 0; le < array_task_epochs_length; ++le) {
                            ...
                            for(uint64_t rep = 0; rep < epochs; ++rep) { 
                                ...
                                epoch_bytes_CPU_DPU += (double) (((double) (NR_DPUS)) * ((double) (2*n_size_pad_W_fp * sizeof(S))));
                                ...
                                epoch_bytes_model_average += (double) (((double) (NR_DPUS)) * ((double) (3*n_size_pad_W_fp * sizeof(S))));
