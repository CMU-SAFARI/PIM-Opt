...
typedef struct {
    ...
    LS* W_ADMM_global_buffer;
    LS* U_ADMM_global_buffer;
    ...
    LS* bias_W_ADMM_global_buffer;
    LS* bias_U_ADMM_global_buffer;

    LS* bias_W_ADMM_global;
    LS* bias_U_ADMM_global;
    LS* bias_W_ADMM_local;
    LS* bias_Z_ADMM_global;
    LS* bias_U_ADMM_local;
    LS* bias_U_Z_ADMM_local;
